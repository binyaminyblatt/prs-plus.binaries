...
static const CSwitchForm kSwitchForms[] =
  {
    ...
    { L"PRSP", NSwitchType::kSimple, false },
    ...
    CArchiveCommandLineOptions &options)
{
  ...
  options.PrspMode = parser[NKey::kPrspMode].ThereIs;
  // If prsp mode is enabled, not showing headers
  options.EnableHeaders = options.EnableHeaders && !options.PrspMode; 
